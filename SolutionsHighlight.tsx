          ...
          <div className="w-full lg:w-1/2 space-y-8">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[14px] font-bold text-[#2F80ED] uppercase tracking-widest font-inter">Precision Monitoring</span>
              </div>
              <h2 className="text-[32px] md:text-[42px] font-bold text-[#0B1F3A] font-montserrat uppercase leading-tight">
                ADVANCED AI-POWERED <br />
                <span className="text-[#2F80ED]">SURVEILLANCE</span>
              </h2>
            ...
            <button className="flex items-center gap-3 bg-[#0B1F3A] text-white px-8 py-4 rounded-[6px] text-[14px] font-bold uppercase tracking-widest font-montserrat hover:bg-[#2F80ED] transition-all shadow-lg group">
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-24">
          <div className="w-full lg:w-1/2 space-y-8">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <span className="w-10 h-[2px] bg-[#2F80ED]"></span>
                <span className="text-[14px] font-bold text-[#2F80ED] uppercase tracking-widest font-inter">Unified Infrastructure</span>
              </div>
              <h2 className="text-[32px] md:text-[42px] font-bold text-[#0B1F3A] font-montserrat uppercase leading-tight">
                INTEGRATED BUILDING <br />
                <span className="text-[#2F80ED]">AUTOMATION</span>
              </h2>
              <p className="text-[17px] text-[#6B7280] font-inter leading-relaxed max-w-xl">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          <div className="w-full lg:w-1/2 space-y-8">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <span className="w-10 h-[2px] bg-[#2F80ED]"></span>
                <span className="text-[14px] font-bold text-[#2F80ED] uppercase tracking-widest font-inter">Seamless Access</span>
              </div>
              <h2 className="text-[32px] md:text-[42px] font-bold text-[#0B1F3A] font-montserrat uppercase leading-tight">
                INTELLIGENT ACCESS <br />
                <span className="text-[#2F80ED]">MANAGEMENT</span>
              </h2>
              <p className="text-[17px] text-[#6B7280] font-inter leading-relaxed max-w-xl">
