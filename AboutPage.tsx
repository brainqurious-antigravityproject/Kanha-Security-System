          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[14px] font-bold text-[#2F80ED] uppercase tracking-widest font-inter">Who We Are</span>
              </div>
              <h1 className="text-[42px] md:text-[64px] font-bold text-white font-montserrat uppercase tracking-tight leading-tight">
                SECURE, SAFE & <span className="text-[#2F80ED]">AUTOMATED</span>
              </h1>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-[#2F80ED] p-8 rounded-xl shadow-xl hidden md:block">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-6">
              <h2 className="text-[36px] font-bold text-[#0B1F3A] font-montserrat uppercase leading-tight">
                ROOTED IN <span className="text-[#2F80ED]">EXPERTISE</span>
              </h2>
              ...
              <div className="space-y-4 pt-4">
                <div className="flex gap-4 p-4 bg-[#F5F7FA] rounded-xl border border-gray-100">
                  <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center shadow-sm text-[#2F80ED]">
                    <Target size={24} />
                  </div>
                  <div>
      ...
      <section className="py-24 bg-[#0B1F3A] text-white">
        <div className="max-w-7xl mx-auto px-6 text-center mb-16">
          <div className="flex justify-center mb-6">
             <span className="text-[#2F80ED] text-[12px] font-bold tracking-[0.3em] uppercase font-inter border border-[#2F80ED]/40 px-6 py-2 rounded-full">
              Our Philosophy
            </span>
          </div>
          <h2 className="text-[36px] md:text-[48px] font-bold font-montserrat uppercase tracking-tight">
            Planning Before <span className="text-[#2F80ED]">Execution</span>
          </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {milestones.map((m, i) => (
            <div key={i} className="group p-8 bg-white/5 rounded-2xl border border-white/10 hover:border-[#2F80ED] transition-all hover:bg-white/10">
              <div className="w-14 h-14 bg-[#2F80ED]/20 rounded-xl flex items-center justify-center text-[#2F80ED] mb-6 group-hover:scale-110 transition-transform">
                <m.icon size={28} />
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative order-2 lg:order-1">
              <div className="absolute -top-12 -left-12 w-64 h-64 bg-[#2F80ED]/10 rounded-full blur-3xl" />
              <div className="relative grid grid-cols-2 gap-4">
                <div className="space-y-4 pt-12">
                  ...
                  <div className="bg-[#0B1F3A] rounded-2xl p-6 text-white text-center">
                    <Award size={32} className="mx-auto mb-2 text-[#2F80ED]" />
                    <span className="text-xs font-bold uppercase tracking-wider block">OEM Certified</span>
                  </div>
                </div>
                <div className="space-y-4">
                   <div className="bg-[#2F80ED] rounded-2xl p-6 text-white text-center">
            ...
            <div className="space-y-8 order-1 lg:order-2">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <span className="w-10 h-[2px] bg-[#2F80ED]"></span>
                  <span className="text-[14px] font-bold text-[#2F80ED] uppercase tracking-widest font-inter">The KSS Edge</span>
                </div>
                <h2 className="text-[36px] md:text-[42px] font-bold text-[#0B1F3A] font-montserrat uppercase leading-tight">
                  UNCOMPROMISING <br />
                  <span className="text-[#2F80ED]">QUALITY STANDARDS</span>
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="flex items-center gap-3">
                  <CheckCircle2 className="text-[#2F80ED]" size={20} />
              ...
              <div className="pt-4">
                <p className="text-sm font-bold text-[#0B1F3A] font-inter uppercase tracking-wide italic border-l-4 border-[#2F80ED] pl-4">
      ...
      <section className="py-20 bg-[#F5F7FA]">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="#contact" className="px-10 py-5 bg-[#0B1F3A] text-white font-bold uppercase tracking-widest rounded-lg hover:bg-[#2F80ED] transition-all shadow-lg font-montserrat">
              Get A Consultation
            </a>
