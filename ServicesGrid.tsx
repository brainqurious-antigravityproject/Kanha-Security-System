  ...
  return (
    <section id="services" className="py-24 bg-[#1F2937]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16">
          <span className="text-[14px] font-bold text-[#2F80ED] uppercase tracking-[0.2em] block mb-4 font-inter">Our Expertise</span>
        ...
        <div className="mt-20 flex justify-center">
          <button 
            ...
            className="bg-transparent border-2 border-[#2F80ED] text-white px-12 py-4 rounded-[6px] text-[14px] font-bold hover:bg-[#2F80ED] transition-all uppercase tracking-widest font-montserrat"
          >
