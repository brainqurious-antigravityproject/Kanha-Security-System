    ...
    <div className="bg-[#F5F7FA] min-h-screen">
      ...
      <section className="pt-40 pb-24 bg-[#0B1F3A] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <div className="flex justify-center mb-6">
            <span className="text-[#2F80ED] text-[12px] font-bold tracking-[0.4em] uppercase font-inter border border-[#2F80ED]/40 px-6 py-2 rounded-full">
              Strategic Ecosystem
            </span>
          </div>
          <h1 className="text-[42px] md:text-[64px] font-bold text-white font-montserrat uppercase tracking-tight leading-tight mb-6">
            OUR <span className="text-[#2F80ED]">TRUSTED</span> NETWORK
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="bg-white p-6 rounded-xl shadow-xl border border-gray-50 flex flex-col items-center text-center">
              <div className="text-[#2F80ED] mb-3">
                <item.icon size={32} />
              </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="mb-16 text-center space-y-4">
          ...
          <div className="w-20 h-1 bg-[#2F80ED] mx-auto rounded-full" />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
          {PARTNER_LOGOS.map((name, i) => (
            <div key={i} className="bg-white p-8 rounded-xl border border-gray-100 flex items-center justify-center text-center shadow-sm hover:shadow-lg hover:border-[#2F80ED]/30 transition-all group min-h-[140px]">
              <span className="text-[14px] md:text-[16px] font-bold text-[#0B1F3A] font-montserrat uppercase tracking-tight group-hover:text-[#2F80ED] transition-colors leading-tight">
                {name}
              </span>
            </div>
          ))}
      ...
      <section className="py-32 max-w-5xl mx-auto px-6 text-center">
        <div className="bg-white rounded-[32px] p-12 md:p-20 shadow-2xl border border-gray-50 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#2F80ED]/5 rounded-bl-full pointer-events-none" />
