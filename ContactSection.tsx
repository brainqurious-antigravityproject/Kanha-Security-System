      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
        ...
        <div className="bg-white p-8 md:p-12 rounded-[24px] shadow-xl border border-gray-100 relative overflow-hidden z-0">
          ...
          >
            ...
            <button 
              type="submit"
              className="w-full py-5 bg-[#0B1F3A] text-white font-bold text-[16px] uppercase tracking-widest rounded-[8px] hover:bg-[#257995] transition-all duration-300 font-montserrat shadow-lg transform active:scale-[0.98]"
            >
              Send Inquiry
            </button>
          </form>
